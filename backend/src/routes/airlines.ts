...
router.get('/my/statistics', authenticate, authorize('airline'), getAirlineStatistics);
router.get('/my/revenue', authenticate, authorize('airline'), getRevenueStatistics);
router.get('/my/passengers', authenticate, authorize('airline'), getPassengerStatistics);

// Admin only routes
router.post('/', authenticate, authorize('admin'), createAirline);
router.post('/invite', authenticate, authorize('admin'), createAirlineByInvitation);
