...
export class BookingService {
  ...
  getUserBookings(
    ...
    return this.http.get<BookingListResponse>(`${this.apiUrl}/bookings`, {
      params,
    });
  }
  ...
  cancelBooking(
    ...
    }>(`${this.apiUrl}/bookings/${bookingId}`, { body });
  }
  ...
  getSeatMap(
    ...
    return this.http.get<{
      ...
      data: { seatMap: SeatMap };
      message?: string;
    }>(`${this.apiUrl}/flights/${flightId}/seats`);
  }
  ...
  checkSeatAvailability(
    ...
    success: boolean;
    data: { available: boolean; unavailableSeats: string[] };
    message?: string;
  }> {
    ...
    return this.http.get<{
      ...
      data: { available: boolean; unavailableSeats: string[] };
      message?: string;
    }>(`${this.apiUrl}/flights/${flightId}/seats/check`, { params });
  }
  ...
  checkIn(
    ...
    success: boolean;
    message?: string;
    data?: { boardingPass: any };
  }> {
    return this.http.post<{
      success: boolean;
      message?: string;
      data?: { boardingPass: any };
    }>(`${this.apiUrl}/bookings/${bookingId}/checkin`, {});
  }
  ...
  getBoardingPass(
    ...
    return this.http.get<{
      ...
      data?: { boardingPass: any };
      message?: string;
    }>(`${this.apiUrl}/bookings/${bookingId}/boarding-pass`);
  }
